...
export default defineSidebarConfig([
  ...
  { text: "更多技巧", icon: "more", collapsable: true, prefix: "more/", children:
    [ "", "01.directory_file", "02.change_bootvideo", "03.reset_setup", "04.install_drastic", "05.locale_zh", "06.mount_fstype", "77.change_bootsplash", "88.change_system", "99.remk_img" ] },
]);
